        ...
        {selectedConversation?.recommendedDoctorId && recommendedDoctor && (
          ...
          <DialogContent className="max-w-md p-8 bg-white rounded-lg shadow-lg">
            <DialogHeader className="mb-6">
              <DialogTitle className="text-2xl font-bold text-gray-800">Doctor Recomendado</DialogTitle>
              <DialogDescription className="text-base text-gray-600">
                Información del especialista recomendado basado en tus síntomas.
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4 text-lg text-gray-800">
              <p>
                <span className="font-semibold">Nombre:</span> Dr. {recommendedDoctor!.firstName} {recommendedDoctor!.lastName}
              </p>
              <p>
                <span className="font-semibold">Especialidad:</span> {recommendedDoctor!.specialty.name}
              </p>
              <p>
                <span className="font-semibold">Ubicación:</span> {recommendedDoctor!.workplace}
              </p>
            </div>
