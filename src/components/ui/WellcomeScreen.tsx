...
export default function WelcomeScreen({ onNewConversation }: { onNewConversation: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center h-full p-8 bg-[#0000000]">
      <div className="text-center mb-8">
        <h2 className="text-4xl font-bold mb-4 text-black">Bienvenido a AlivIA</h2>
      ...
      <div className="w-32 h-32 mb-8 relative">
        ...
        <MessageCircle className="absolute inset-0 m-auto text-teal-300" size={64} />
      </div>

      <div className="text-center space-y-6 max-w-md">
        <p className="text-lg mb-4 text-black">Inicia una nueva conversación para comenzar.</p>
        <Button 
